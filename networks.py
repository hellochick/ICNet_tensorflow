...
class Network(object):
    ...
    def restore(self, data_path, var_list=tf.global_variables()):
    ...
    ## Restore from .npy
    def load_npy(self, data_path, session, ignore_missing=False, var_list=tf.global_variables()):
